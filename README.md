...
## Running the code
  1. Pull the gdrl image with: `docker pull mimoralea/gdrl:v0.10`
  2. Spin up a container: `docker run -it --rm -p 8888:8888 -v "$PWD"/notebooks/:/mnt/notebooks/ mimoralea/gdrl:v0.10` (remember to use `nvidia-docker` if you are using a GPU.)
