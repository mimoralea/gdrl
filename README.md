...
## Running the code
  ...
  2. Spin up a container: `docker run -it --rm -p 8888:8888 -v "$PWD"/notebooks/:/mnt/notebooks/ mimoralea/gdrl:v0.14` (remember to use `nvidia-docker` if you are using a GPU.)
